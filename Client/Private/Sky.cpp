...
HRESULT CSky::Initialize(void * pArg)
{
	...
	_float fVolume = 0.7f;
	pGameInstance->PlayBGM(TEXT("MafiaHQ_SinisterVariaton.ogg"), fVolume);
...
HRESULT CSky::Ready_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), LEVEL_GAMEPLAY_PLATFORM, TEXT("Prototype_Component_Texture_Sky"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
