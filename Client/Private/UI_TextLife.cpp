...
void CUI_TextLife::Late_Tick(_float fTimeDelta)
{
...
HRESULT CUI_TextLife::Ready_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_text_life"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CUI_TextLife::SetUp_ShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
