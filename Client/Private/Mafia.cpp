...
_float CMafia::Take_Damage(float fDamage, void * DamageType, CGameObject * DamageCauser)
{
...
void CMafia::Update_Collider(void)
{
...
void CMafia::Play_FSM(_float fTimeDelta)
{
	//Check_FightMode();
...
_bool CMafia::Idle(_float fTimeDelta)
{
...
_bool CMafia::Move(_float fTimeDelta)
{
...
_bool CMafia::Death(_float fTimeDelta)
{
...
_bool CMafia::Attack(_float fTimeDelta)
{
...
_bool CMafia::Follow_Enemy(_float fTimeDelta)
{
	if (m_eCurrentAnimState != ANIM_STATE::WALK)
	{
		m_eCurrentAnimState = ANIM_STATE::WALK;
...
_bool CMafia::Punch(_float fTimeDelta)
{
...
_bool CMafia::Throw_Item(_float fTimeDelta)
{
...
_bool CMafia::Dive_Attack(_float fTimeDelta)
{
...
_bool CMafia::Hurt(_float fTimeDelta)
{
...
void CMafia::Create_HitImpact(_float fTimeDelta)
{
	CGameInstance*			pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
void CMafia::Play_Sound(_uint iSoundNum)
{
	if (!m_bSoundPlay)
		return;
...
_bool CMafia::IsDetect(_uint eSphere_Scale, CCollider* pTargetCollider)
{
...
void CMafia::IsShoot_Objects(_bool bShoot)
{
...
HRESULT CMafia::Create_ThrowingObject()
{
	return E_NOTIMPL;
}

void CMafia::Walk_ArrviePoint(_float fTimeDelta)
{
...
void CMafia::Init_Type()
{
	...
	case 1://응원
		m_eCurrentState = BEHAVIOR_STATE::IDLE;
		m_eCurrentAnimState = (ANIM_STATE)i;
		m_pModelCom->Set_CurrentAnimIndex(m_eCurrentAnimState);
		m_pModelCom->Set_NextAnimIndex(m_eCurrentAnimState);
		break;
	case 2://가드
...
void CMafia::Ready_Detect(_float3 fColliderPos)
{
